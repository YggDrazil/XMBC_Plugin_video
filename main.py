...
VIDEOS = {'Lesben': [{'name': 'Gym only for Three Lesbians',
            ...
            'Teenie': [{'name': 'Grosser Schwanz in kleiner Muschi',
                     ...
                     {'name': 'While Student Girls are playing Games...',
                      ...
                      'genre': 'Teenie'},
                       {'name': 'Flexible Girl prefers Sex Instead Massage',
                      'thumb': 'http://s15.bigcdn.cc/pub/cid/58eb170350ea3/main.jpg',
                      'video': 'http://s15.bigcdn.cc/pub/cid/58eb14f2cb593/720.mp4',
                      'genre': 'Teenie'},
         ...
         'Russian': [{'name': 'Nedda from Russia',
                      ...
                      'genre': 'Russian'},
                     {'name': 'She´s getting Truly Deep Orgasms',
                      'thumb': 'http://s12.bigcdn.cc/pub/cid/58eb2381a60d3/main.jpg',
                      'video': 'http://s12.bigcdn.cc/pub/cid/58eb25d65327e/720.mp4',
                      'genre': 'Russian'},
                      {'name': 'Naked Surprise',
